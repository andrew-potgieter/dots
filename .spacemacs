...
you should place your code here."
  ...
  (global-set-key (kbd "<s-return>") #'spacemacs/cider-eval-region)
  (global-set-key (kbd "<s-l>") #'spacemacs/cider-load-buffer)
  ...
  (global-set-key (kbd "<M-right>") #'evil-forward-WORD-begin)
  (global-set-key (kbd "<M-left>") #'evil-backward-WORD-begin)
